...
var
   ...
   songs = ['audio/TheBeeGees-StayinAlive.mp3',
            'audio/boney-m-rasputin.mp3',
            'audio/Gloria-Gayno-I-Will-Survive.mp3',
            'audio/anita-ward-ring-my-bell.mp3',
            ],
   songTitle = songs[getRandomIndex(songs.length)],
   audio = new Audio(songTitle),
